...
const docTypography = {
  ...
  sections: [
    ...
    },
    {
      ...
      note: "Aligned to Atlassian's published type scale (2026-08-25) — Display maps onto Atlassian's Heading XXL/XL/L, Heading H1–H3 onto Heading M/S/XS.",
      table: {
...
const docMotion = {
  ...
  description: "Quiet and functional. Productive easing for everyday UI, expressive for moments that should feel considered. Six duration steps, no bounces, no infinite decorative loops.",
  sections: [
    {
      ...
      table: {
        head: ["Token", "Value", "Use"],
        rows: [
          ["--ease-standard-productive", "cubic-bezier(0.2, 0, 0.38, 0.9)", "Default for everyday transitions"],
          ...
          ["--duration-fast-02", "110ms", "Hovers, small state changes"],
      ...
      code: `transition: background var(--duration-fast-02) var(--ease-standard-productive);`,
    },
  ],
};
