  ...
  return (
    <label style={{
      ...
      <span style={{
        ...
        {indeterminate ? (
          <svg width="12" height="12" viewBox="0 0 24 24" stroke="var(--colour-neutral-0)" strokeWidth="3" strokeLinecap="round"><line x1="5" y1="12" x2="19" y2="12" /></svg>
        ) : checked ? (
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="var(--colour-neutral-0)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>
        ) : null}
      </span>
